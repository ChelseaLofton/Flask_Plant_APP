                    ...
                    <div className="modal-body">
                        {sensorData && (
                            <div id="plant-sensor-data">
                                ...
                                Illuminance: {sensorData.illuminance}lux; Conductivity: {sensorData.conductivity};
                        ...
                        {plantBookData && (
                            <div id="plantbook-data">
                                ...
                                Alias: {plantBookData.alias}; Category: {plantBookData.category}; Max Light: {plantBookData.max_light_lux}lux;
                                Min Light: {plantBookData.min_light_lux}lux; Max Temperature: {plantBookData.max_temp}°F; Min Temperature: {plantBookData.min_temp}°F;
                                Max Env. Humidity: {plantBookData.max_env_humid}%; Min Env. Humidity: {plantBookData.min_env_humid}%; Max Soil Moisture: {plantBookData.max_soil_moist}%;
                                Min Soil Moisture = {plantBookData.min_soil_moist}%; Max Soil EC: {plantBookData.max_soil_ec}; Min Soil EC: {plantBookData.min_soil_ec};
                            </div>
                        )}
                    </div>
                </div>
